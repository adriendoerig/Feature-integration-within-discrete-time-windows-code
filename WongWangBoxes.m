...
% in case the network doesn't reach a decision, 
% these are just average values so it doesn't bug during fminsearch.
decision = 0.5;
DT = 300;
success = 0;

t_stab = .5;  % [s], time to let the network stabilize before sending input (there are erratic fluctuations before the network is stable)
